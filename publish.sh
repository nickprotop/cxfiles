...
echo "  https://github.com/nickprotop/cxfiles/actions"
echo ""
echo "Release will be at:"
echo "  https://github.com/nickprotop/cxfiles/releases/tag/$NEW_TAG"
